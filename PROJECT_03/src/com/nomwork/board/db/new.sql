...
CONSTRAINT CT_FK_FILEN0O FOREIGN KEY(FILENO) REFERENCES FILEDB(FILENO) ON DELETE CASCADE --fileno FK, 삭제시 filedb에서도 삭제
);
...
CONSTRAINT TT_FK_FILEN0O FOREIGN KEY(FILENO) REFERENCES FILEDB(FILENO) ON DELETE CASCADE --fileno FK, 삭제시 filedb에서도 삭제
);
