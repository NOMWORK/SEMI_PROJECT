...
<script type="text/javascript">
	...
	function search() {
		...
		location.href='/PROJECT_03/User.ho?command=search_user_by_email&useremail='+useremail;
	}
	function confirm() {
		var useremail = document.getElementById("useremail").value;
		opener.location.href='/PROJECT_03/Project.ho?command=project_add_user_list&useremail=' + useremail;
		self.close();
	}
